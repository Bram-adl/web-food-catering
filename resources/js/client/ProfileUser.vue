        ...
        <transition enter-active-class="animate__animated animate__fadeIn animate__faster" leave-active-class="animate__animated animate__fadeOut animate__faster">
            ...
            >
                <div class="mt-2">
                    ...
                    <input type="text" name="nama" id="nama" autocomplete="given-name" class="focus:outline-none flex-1 block w-full rounded-md sm:text-sm border border-gray-300 mt-1 px-3 py-2" placeholder="Nama Lengkap">
                ...
                <div class="mt-2">
                    ...
                    <input type="email" name="email" id="email" autocomplete="email" class="focus:outline-none flex-1 block w-full rounded-md sm:text-sm border border-gray-300 mt-1 px-3 py-2" placeholder="Email">
                    <!-- <p class="mt-1 text-sm text-red-400 italic">
                        Error feedback
                    </p> -->
                </div>
                ...
                <div class="mt-2">
                    ...
                    <input type="password" name="password" id="password" autocomplete="family-name" class="focus:outline-none flex-1 block w-full rounded-md sm:text-sm border border-gray-300 mt-1 px-3 py-2" placeholder="Kosongkan jika tidak merubah">
                    <!-- <p class="mt-1 text-sm text-red-400 italic">
                        Error feedback
                    </p> -->
                </div>
                ...
                <div class="mt-2">
                    ...
                    <input type="number" name="wa" id="wa" autocomplete="family-name" class="focus:outline-none flex-1 block w-full rounded-md sm:text-sm border border-gray-300 mt-1 px-3 py-2" placeholder="Nomor WA">
                    <!-- <p class="mt-1 text-sm text-red-400 italic">
                        Error feedback
                    </p> -->
                </div>
                ...
                <div class="mt-2">
                    ...
                    <div class="mt-1">
                        <textarea id="rumah_teks" name="rumah_teks" rows="3" class="focus:outline-none shadow-sm mt-1 block w-full sm:text-sm border border-gray-300 rounded-md px-3 py-2" placeholder="Tuliskan alamat rumah lengkap"></textarea>
                    </div>
                    <!-- <p class="mt-1 text-sm text-red-400 italic">
                        Error feedback
                    </p> -->
                ...
                <div class="mt-2">
                    <div>
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm focus:outline-none w-full sm:text-sm">
                            ...
                            <input type="text" name="rumah_maps" id="rumah_maps" class="focus:outline-none flex-1 block w-full rounded-none rounded-r-md sm:text-sm border border-gray-300 px-3 py-2" placeholder="www.example.com">
                        </div>
                    </div>
                    <!-- <p class="mt-1 text-sm text-red-400 italic">
                        Error feedback
                ...
                <div class="mt-2 mb-2">
                    <div class="grid grid-cols-3 gap-3">
                        <div>
                            ...
                            <select id="rumah_kota" name="rumah_kota" autocomplete="rumah_kota" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <select id="kecamatan" name="kecamatan" autocomplete="kecamatan" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <option>United States</option>
                                <option>Canada</option>
                                <option>Mexico</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select id="kelurahan" name="kelurahan" autocomplete="kelurahan" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <option>United States</option>
                                <option>Canada</option>
                                <option>Mexico</option>
                            </select>
                ...
                <div class="mt-2">
                    ...
                    <div class="mt-1">
                        <textarea id="kantor_teks" name="kantor_teks" rows="3" class="focus:outline-none shadow-sm mt-1 block w-full sm:text-sm border border-gray-300 rounded-md px-3 py-2" placeholder="Tuliskan alamat kantor lengkap"></textarea>
                    </div>
                    <!-- <p class="mt-1 text-sm text-red-400 italic">
                        Error feedback
                    </p> -->
                ...
                <div class="mt-2">
                    <div>
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm focus:outline-none w-full sm:text-sm">
                            ...
                            <input type="text" name="kantor_maps" id="kantor_maps" class="focus:outline-none flex-1 block w-full rounded-none rounded-r-md sm:text-sm border border-gray-300 px-3 py-2" placeholder="www.example.com">
                        </div>
                    </div>
                    <!-- <p class="mt-1 text-sm text-red-400 italic">
                        Error feedback
                ...
                <div class="mt-2 mb-2">
                    <div class="grid grid-cols-3 gap-3">
                        <div>
                            ...
                            <select id="kantor_kota" name="kantor_kota" autocomplete="kantor_kota" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <option>United States</option>
                                <option>Canada</option>
                                <option>Mexico</option>
                            </select>
                ...
                <div class="mt-2">
                    ...
                    <div class="mt-1">
                        <textarea id="keterangan" name="keterangan" rows="3" class="focus:outline-none shadow-sm mt-1 block w-full sm:text-sm border border-gray-300 rounded-md px-3 py-2" placeholder="Tuliskan keterangan seperti alergi dan lainnya."></textarea>
                    </div>
                    <!-- <p class="mt-1 text-sm text-red-400 italic">
                        Error feedback
                    </p> -->
